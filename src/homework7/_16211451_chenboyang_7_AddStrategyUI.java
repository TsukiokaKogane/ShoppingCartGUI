...
public class _16211451_chenboyang_7_AddStrategyUI extends JDialog implements ActionListener,ItemListener{
	 ...
	 * Create the dialog.
	 */
	public _16211451_chenboyang_7_AddStrategyUI(_16211451_chenboyang_7_Controller c) {
		setResizable(false);
		setTitle("Add Strategy");
		setModal(true);
		controller=c;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnSubmit) {
			try {
			if(txtStrategynumber.getText().equals(""))throw new _16211451_chenboyang_7_generalException("en");
			...
			if(controller.getStrategy(txtStrategynumber.getText())!=null)throw new _16211451_chenboyang_7_generalException("sn");
